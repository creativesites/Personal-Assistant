...
See `docs/ADVISOR_COMPANION_PLAN.md` for the full plan — Advisor's emotional/companion layer built on top of the Zuri Neural Layer above. Phase 0 ("Emotional Foundation"), Phase 1 ("Companion Brain Foundation"), and Phase 2 ("Relationship Analysis Experience") are shipped; Phases 3–6 (action protocol, watch/narration, the proactive companion crons, the learning loop, scoped automation) remain unstarted.
