...
See `docs/ADVISOR_COMPANION_PLAN.md` for the full plan — Advisor's emotional/companion layer built on top of the Zuri Neural Layer above. Phase 0 ("Emotional Foundation") and Phase 1 ("Companion Brain Foundation") are shipped; Phases 2–6 (relationship analysis, action protocol, watch/narration, the proactive companion crons, the learning loop, scoped automation) remain unstarted.
