...
**Not yet built** (per the plan's own §18 build order, next up): Tailored Variants/Job Matching UI (Phase 8) and Cover Letter Studio/Supporting Documents (Phase 9).
