...
import {
  Zap, Users, Bell, ShieldCheck, ArrowRight, Check,
...
export const metadata: Metadata = {
  ...
  description: 'Zuri helps you respond to customers faster with AI reply suggestions that sound like you. Never lose a lead because you were too busy to type.',
}
...
export default function WhatsAppProductPage() {
  return (
    <div>
      ...
      {/* ── Industries ───────────────────────────────────────────────────── */}
      <section id="industries" className="bg-gray-50 py-20 md:py-28 px-4 md:px-6">
        <div className="max-w-5xl mx-auto">
