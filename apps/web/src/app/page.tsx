...
import {
  ...
  Plane, Scale, GraduationCap, Smartphone, CreditCard, Sparkles,
} from 'lucide-react'
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-1">
        ...
        {/* ── Zuri Marketing teaser ────────────────────────────────────────── */}
        <section className="py-16 md:py-20 px-4 md:px-6">
          <div className="max-w-4xl mx-auto bg-gradient-to-br from-indigo-600 to-indigo-700 rounded-3xl p-8 md:p-12 text-center shadow-xl shadow-indigo-200/50">
            <div className="inline-flex items-center gap-2 bg-white/10 px-4 py-2 rounded-full text-sm font-medium text-indigo-100 mb-5">
              <Sparkles className="w-4 h-4" />
              New — coming to Zuri
            </div>
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">
              One product upload. Posts for Facebook, Instagram &amp; TikTok. Leads straight into WhatsApp.
            </h2>
            <p className="text-indigo-100 max-w-xl mx-auto mb-7 leading-relaxed">
              Zuri Marketing writes your captions, builds your video scripts, and schedules your posts — then tracks
              every lead all the way to a sale, in the same system you already use for your inbox.
            </p>
            <Link
              href="/social-commerce"
              className="inline-flex items-center justify-center gap-2 px-6 py-3.5 bg-white text-indigo-600 font-semibold rounded-xl hover:bg-indigo-50 transition-colors shadow-sm"
            >
              See how it works
              <ArrowRight className="w-4 h-4" />
            </Link>
