...
**Not done yet:** the memory transparency UI (Phase 5) — including the still-missing frontend for approving/rejecting business facts (Phase 2) and browsing agent memories (Phase 3).
