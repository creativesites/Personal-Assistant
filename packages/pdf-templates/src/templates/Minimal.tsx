...
// Deliberately Helvetica/Helvetica-Bold only (built into @react-pdf/renderer,
...
const styles = StyleSheet.create({
  page: { fontFamily: 'Helvetica', fontSize: 10, color: '#1f2937', padding: 36 },
  ...
  companyMeta: { fontSize: 8, color: '#6b7280', marginTop: 3, lineHeight: 1.4 },
  docTitleBlock: { alignItems: 'flex-end' },
  docTitle: { fontSize: 17, fontFamily: 'Helvetica-Bold', letterSpacing: 1, textTransform: 'uppercase' },
  docNumber: { fontSize: 9, color: '#6b7280', marginTop: 3 },
  metaGrid: { flexDirection: 'row', justifyContent: 'space-between', gap: 28, marginBottom: 20 },
  metaBlock: { flex: 1 },
...
export default function Minimal({ document, business, contact }: TemplateProps) {
  ...
  return (
    <Document>
      <Page size="A4" style={[styles.page, { borderBottomWidth: 0 }]}>
        <View style={[styles.header, { borderBottomWidth: 2, borderBottomColor: themeColor }]}>
          <View>
