            ...
            <>
              <View style={styles.table}>
                <View style={[styles.tableHeader, { backgroundColor: themeColor }]}>
                  <View style={[styles.colDesc, { paddingLeft: 8 }]}><Text style={styles.tableHeaderCell}>Description</Text></View>
                  ...
                  <View style={[styles.colTotal, { paddingRight: 8 }]}><Text style={styles.tableHeaderCell}>Total</Text></View>
                </View>
              ...
              <View style={styles.totals}>
                ...
                <View style={[styles.grandRow, { backgroundColor: themeColor }]}>
