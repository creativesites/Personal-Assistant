    ...
    return reply.send({
      providers: [
        ...
        },
        {
          ...
          recommended_models: [
            { id: 'qwen-max', name: 'Qwen Max', type: 'flagship', description: 'Recommended. Premium large model.', recommended: true },
            { id: 'qwen-plus', name: 'Qwen Plus', type: 'general', description: 'Balanced speed & high performance.' },
            { id: 'qwen-turbo', name: 'Qwen Turbo', type: 'fast', description: 'Lightning-fast, low latency model.' },
            { id: 'qwen-long', name: 'Qwen Long', type: 'long-context', description: 'Ultra-long context window up to 10M tokens.' },
            { id: 'qwen2.5-72b-instruct', name: 'Qwen 2.5 72B', type: 'flagship', description: 'Open weights flagship model.' },
            { id: 'qwen2.5-coder-32b-instruct', name: 'Qwen 2.5 Coder', type: 'coding', description: 'Specialized coding assistant.' },
            { id: 'qwen2.5-vl-72b-instruct', name: 'Qwen 2.5 VL', type: 'vision', description: 'Multimodal vision model.' },
          ],
        },
        {
          id: 'openrouter',
